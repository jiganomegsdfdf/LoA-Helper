...
import com.rxuglr.loahelper.util.Commands.backup
import com.rxuglr.loahelper.util.Commands.flashuefi
import com.rxuglr.loahelper.util.Commands.mountstatus
import com.rxuglr.loahelper.util.Commands.mountlinux
import com.rxuglr.loahelper.util.Commands.quickboot
import com.rxuglr.loahelper.util.Commands.umountlinux
...
import com.rxuglr.loahelper.util.Variables.paddingValue
        ...
        Card(
            ...
            when {
                showMountDialog.value -> {
                    if (mountstatus()) {
                        PopupDialogs.Dialog(
                            icon = painterResource(id = R.drawable.ic_ubuntu),
                            title = null,
                        ...
                        PopupDialogs.Dialog(
                            painterResource(id = R.drawable.ic_ubuntu),
                            null,
            ...
            Row(
                ...
                Icon(
                    modifier = Modifier
                        .size(40.dp),
                    painter = painterResource(id = R.drawable.ic_ubuntu),
                    contentDescription = null,
                    tint = MaterialTheme.colorScheme.primary
                )
                Column {
